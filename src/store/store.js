...
import * as reportEpics from '../epics/reports/reports';
...
export default (initialState = {}) => {
    ...
    const pingEpic2 = action$ =>
     ...
     const rootEpic = combineEpics(
         ...
         pingEpic2,
         reportEpics.getMissingEpics,
         reportEpics.getCrimeEpics,
         reportEpics.getComplainEpics,
         reportEpics.addReportsEpics,
