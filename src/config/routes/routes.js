...
import complain from '../../containers/complain/complain'
import registerReports from '../../containers/registerReports/registerReports'
  ...
  <Router history={history}>
     <Route path='/' component={App}>
        ...
        <Route path='signup' component={signup} />
         ...
         <Route path='crimereports' component={crime} />
         <Route path='missingreports' component={missing} />
         <Route path='complainreports' component={complain} />
         <Route path='registerreports' component={registerReports} />
